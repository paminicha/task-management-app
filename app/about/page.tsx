    ...
    <div className="max-w-6xl mx-auto px-6 py-12 space-y-16">
      ...
      {/* TECH STACK */}
        <section className="bg-gray-50 rounded-xl p-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div className="flex flex-col items-center gap-3 p-6 bg-white rounded-xl shadow hover:shadow-lg transition">
                <img
      ...
      <section className="bg-gray-100 rounded-xl p-8">
        <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="md:col-span-2 flex flex-col gap-6 text-gray-700">
                <div className="flex items-start gap-3">
                    <Component className="text-green-600 mt-1" />
                    <p>Building reusable React components</p>
                </div>
