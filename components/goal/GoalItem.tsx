...
function GoalItem({goal, onclick}: Props) {
  return (
    <div className="w-32 shrink-0 bg-gray-50 p-2 rounded-xl border-gray-300 border shadow-sm flex flex-col">
      <div>
        {/* OLD: <h4 className="font-semibold text-gray-600 text-wrap"> {goal.title} </h4>  Alternative 2 line clamp(no installation): className="font-semibold text-gray-600 w-full break-words overflow-hidden display:-webkit-box] [-webkit-line-clamp:2] [-webkit-box-orient:vertical]"*/}
